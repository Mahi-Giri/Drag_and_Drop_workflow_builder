...
export const selectNodeFactory = nodeFactory(SELECT_NODE_IDENTIFIER, SelectNodeSettings, () => ({ item: null }));
...
export const SelectNodeBlock = () => (
    <NodeBlockComposer identifier={SELECT_NODE_IDENTIFIER} icon={Atom} title="Select" />
);
